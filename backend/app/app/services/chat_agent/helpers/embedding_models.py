...
def get_embedding_model(emb_model: str = None) -> CacheBackedEmbeddingsExtended:
    """
    ...
    Args:
        emb_model: The embedding model type.

    Returns:
        An instance of CacheBackedEmbeddingsExtended.
    """
